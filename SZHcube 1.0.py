...
pygame.display.set_caption("六步解三阶魔方1.0---源自1213清心")
...
for i in [0,1,2,3,4,5,6,7,8]:
    store[i].add(5)
#块存入颜色标准
face2store=[[[24,15,6],[25,16,7],[26,17,8]],\
...
for k in range(6):
    for i in range(3):
        for j in range(3):
            question[face2store[k][i][j]].add(face[k][i][j])
#面信息化为块位置信息
cube = []
for i in range(27):
    cube.append(i)
...
def doF():
    [cube[24],cube[25],cube[26],\
     ...
     face[0]=rotate([cube[24],cube[25],cube[26],\
                     cube[15],cube[16],cube[17],\
                     cube[6],cube[7],cube[8]],face[0])
    t=face[3][0]
...
def unF():
    [cube[24],cube[25],cube[26],\
     cube[15],cube[16],cube[17],\
     cube[6],cube[7],cube[8]],\
    face[0]=unrotate([cube[24],cube[25],cube[26],\
                      cube[15],cube[16],cube[17],\
                      cube[6],cube[7],cube[8]],face[0])
    t=face[3][0]
...
def doL():
    ...
    face[2]=rotate([cube[18],cube[21],cube[24],\
                    cube[9],cube[12],cube[15],\
                    cube[0],cube[3],cube[6]],face[2])
    t=face[0][0]
    face[0][0]=face[4][0]
...
def unL():
    [cube[18],cube[21],cube[24],\
     cube[9],cube[12],cube[15],\
     cube[0],cube[3],cube[6]],\
    face[2]=unrotate([cube[18],cube[21],cube[24],\
                      cube[9],cube[12],cube[15],\
                      cube[0],cube[3],cube[6]],face[2])
    t=face[0][0]
    face[0][0]=face[5][0]
...
def doR():
    ...
    face[3]=rotate([cube[26],cube[23],cube[20],\
                    cube[17],cube[14],cube[11],\
                    cube[8],cube[5],cube[2]],face[3])
    t=face[1][0]
...
def unR():
    [cube[26],cube[23],cube[20],\
     cube[17],cube[14],cube[11],\
     cube[8],cube[5],cube[2]],\
    face[3]=unrotate([cube[26],cube[23],cube[20],\
                      cube[17],cube[14],cube[11],\
                      cube[8],cube[5],cube[2]],face[3])
    t=face[1][0]
...
def doU():
    [cube[18],cube[19],cube[20],\
     ...
     cube[24],cube[25],cube[26]],\
    face[4]=rotate([cube[18],cube[19],cube[20],\
                    cube[21],cube[22],cube[23],\
                    cube[24],cube[25],cube[26]],face[4])
...
def unU():
    [cube[18],cube[19],cube[20],\
     cube[21],cube[22],cube[23],\
     cube[24],cube[25],cube[26]],\
    face[4]=unrotate([cube[18],cube[19],cube[20],\
                      cube[21],cube[22],cube[23],\
                      cube[24],cube[25],cube[26]],face[4])
    t=[face[3][2][0],face[3][1][0],face[3][0][0]]
    [face[3][2][0],face[3][1][0],face[3][0][0]]=\
    ...
    SZHsolve.append('u')
def doB():
    [cube[20],cube[19],cube[18],\
     cube[11],cube[10],cube[9],\
     cube[2],cube[1],cube[0]],\
    face[1]=rotate([cube[20],cube[19],cube[18],\
                    cube[11],cube[10],cube[9],\
                    cube[2],cube[1],cube[0]],face[1])
    t=face[2][0]
...
def unB():
    [cube[20],cube[19],cube[18],\
     cube[11],cube[10],cube[9],\
     cube[2],cube[1],cube[0]],\
    face[1]=unrotate([cube[20],cube[19],cube[18],\
                    cube[11],cube[10],cube[9],\
                    cube[2],cube[1],cube[0]],face[1])
    t=face[2][0]
...
def doD():
    ...
    face[5]=rotate([cube[6],cube[7],cube[8],\
                    cube[3],cube[4],cube[5],\
                    cube[0],cube[1],cube[2]],face[5])
...
def unD():
    [cube[6],cube[7],cube[8],\
     cube[3],cube[4],cube[5],\
     cube[0],cube[1],cube[2]],\
    face[5]=unrotate([cube[6],cube[7],cube[8],\
                    cube[3],cube[4],cube[5],\
                    cube[0],cube[1],cube[2]],face[5])
    t=[face[3][0][2],face[3][1][2],face[3][2][2]]
    face[3][0][2],face[3][1][2],face[3][2][2]=\
